...
ejemplo.decodificar_archivo('texto_hammificado.txt','texto_decodificado.txt',1)

ejemplo.ingresar_error('texto_hammificado.txt','texto_error.txt')

ejemplo.decodificar_archivo('texto_error.txt','texto_decodificado_error.txt',1)
